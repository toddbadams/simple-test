...
//    _T.createModuleTest(PERSON_CNTRL_MODULE_NAME)
//        .injectProvider({ module: 'ui.router', provider: 'state', value: $stateProvider })
//        .injectService({ module: 's.logging', service: 'loggingService', value: loggingService })
//        .injectService({ module: 's.person.data', service: 'personDataService', value: personDataService })
//        .describe(function () {
//            var moduleTest = this;
...
//            moduleTest.createServiceTest(PERSON_CNTRL_MODULE_RESOLVER_NAME)
